...
# spotify_network_analysis documentation build
...
from spotify_network_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "spotify_network_analysis"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "spotify_network_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "spotify_network_analysis.tex",
        "spotify_network_analysis Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spotify_network_analysis",
        "Project spotify_network_analysis codebase.",
        "Data-Science",
    )
]
